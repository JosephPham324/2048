...
public class StatDisplay extends javax.swing.JFrame {
    ...
    private void displayInfo() {
        ...
        setLabel(_2048fewestMoves, fewestMoves2048, this.info.getMilestoneInfo(2048).getFewestMoves() + "");

        if (this.info.getMilestoneInfo(2048).getGamesReached() == 0) {
            this._2048.setText("");
        }
        if (this.info.getMilestoneInfo(1024).getGamesReached() == 0) {
            this._1024.setText("");
        }
        if (this.info.getMilestoneInfo(512).getGamesReached() == 0) {
            this._512.setText("");
        }
    }
    ...
    private void initComponents() {
        ...
        reset.setFont(new java.awt.Font("Arial Narrow", 1, 24)); // NOI18N
    ...
    private void resetMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_resetMouseClicked
        if (JOptionPane.showConfirmDialog(this, "Reseting statistics will also reset the current game, are you sure?", "Confirmation",
